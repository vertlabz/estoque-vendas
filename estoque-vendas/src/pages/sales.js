...
export default function SalesPage() {
  ...
  if (loading) return <div className="p-6 text-white">Carregando vendas...</div>;
              ...
              <table className="w-full text-sm border-collapse border border-gray-700">
                <thead>
                  <tr className="bg-gray-700">
                    <th className="border border-gray-600 px-3 py-2">Produto</th>
                    <th className="border border-gray-600 px-3 py-2">Qtd</th>
                    <th className="border border-gray-600 px-3 py-2">Preço Unit.</th>
                    <th className="border border-gray-600 px-3 py-2">Subtotal</th>
                  </tr>
                </thead>
                <tbody>
                  {sale.items.map((item) => (
